...
Historical examples include poll taxes, literacy tests, grandfather clauses, and violence and intimidation targeted at suppressing the voting rights of African Americans and other marginalized groups.</div><div className="faq-question">
What groups are most affected by voter disenfranchisement?</div><div className="faq-answer">
